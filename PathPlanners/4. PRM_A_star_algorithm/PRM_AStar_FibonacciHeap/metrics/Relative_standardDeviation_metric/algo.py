...
class Graph:
    ...
    def a_star(self):
        ...
        open_list = []
        heapq.heappush(open_list, (self.get_distance(start), start))
        closed_list = set()
        ...
        while open_list:
            ...
            for neighbor in neighbors:
                ...
                if tentative_distance < self.get_distance(neighbor):
                    self.set_distance(neighbor, tentative_distance)
                    heapq.heappush(open_list, (tentative_distance + self.calculate_heuristic(neighbor), neighbor))
